# Lab 4 - Hangman Game (Jogo da Forca) 
...
def rand_palavra():
    ...
    lista_palavras = ['banana', 'abacate', 'uva', 'morango', 'laranja', 'abacaxi']
...
def main():
    ...
    # De acordo com o statur imprime mensagem na tela para o usuário
    if game.win():
